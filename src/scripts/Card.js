export default class Card{
  constructor({ name, link, likes, _id, owner, userId, cardTemplate, handleCardClick, handleTrashClick, handleLikeClick }){
    this._name = name;
    this._link = link;
    this._likes = likes;
    this._cardId = _id;
  ...
  create(){
    ...
    if(this._likes.some((el) => {return el['_id'] == this._userId})){
